<x-jet-action-section>
    ...
    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{ __('Dispositivos donde ha iniciado sesión:') }}
        </div>
        ...
        <div class="flex items-center mt-5">
            <x-jet-button class="btn" wire:click="confirmLogout" wire:loading.attr="disabled">
                {{ __('Cerrar sesion en todos los demas dispositivos') }}
            </x-jet-button>
